...
平台已全面适配手机浏览器（视口 ≤ 640px）：

| 适配项 | 桌面端 | 手机端 |
|:---|:---|:---|
| 导航栏 | 8 个 Tab 横排 | ☰ 汉堡菜单 → 竖排列表 |
| KPI 卡片 | 4 列网格 | 2 列网格 |
| 图表 | 全高 | 压缩至 200px |
| 弹窗 | 固定宽度 | 92vw 自适应 |
| 浮动控制器 | 固定右下角 | 可拖拽 + × 关闭 |
| 菜单层级 | z-index 9999 | 不被图表/地图覆盖 |
| 新增客户 | 全字段表单 | 9 字段含 GPS/MFI |
...
| 文档 | 位置 | 说明 |
|:---|:---|:---|
| 升级迭代计划 | `docs/项目文档/平台升级迭代计划.md` | 10 Phase 完整记录 |
| 演示流程手册 | `docs/项目文档/平台演示流程手册.md` | 4 角色 × 25 步 |
| 需求规格说明书 | `docs/项目文档/平台需求规格说明书_PRD_V1.0.md` | FR-OPS-001~008 |
| 系统架构设计 | `docs/项目文档/系统架构设计说明书_V1.0.md` | 微服务/部署/安全 |
| 云端部署指导 | `docs/项目文档/云部署指导手册.md` | Railway/Render/VPS + 发布流程 |
| 加密解密机制 | `docs/项目文档/加密解密机制说明.md` | Fernet/bcrypt/JWT 原理与排查 |
| 开发上下文 | `CLAUDE.md` | 架构/命令/规范 |
